...
def authenticate():
    ...
    creds = None
    # Attempt to use OAuth if CLIENT_SECRET_FILE is provided
    ...
    # Fallback to service account if OAuth isn't available
...
def format_datetime(dt):
    """Convert datetime object to a more readable format."""
